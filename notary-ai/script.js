...
function debugLog(message, data = null) {
    console.log(`[NotaryAI Debug] ${message}`, data || '');
}
    ...
    text.innerHTML = `
        <div class="loading-dots">
            ...
            <span></span>
                        ...
                        <span>Analyzing your notary question...</span>
    `;
    ...
    try {
        ...
        const requestBody = {
            ...
            messages: [
                {
                    role: 'system',
                    content: `You are NotaryAI, an advanced AI notary assistant. You are having a friendly but professional conversation with a notary professional. Your responses should be:
...
- Provide expert-level notary guidance
- Reference specific state statutes when relevant
...
COMPLIANCE-FOCUSED:
- Mention important notary requirements
- Highlight potential risks or considerations
- Note documentation needs
- Include relevant procedures when applicable

Remember: You're chatting with a notary professional who values expertise and efficiency. Be helpful, accurate, and personable.`
                },
...
document.addEventListener('DOMContentLoaded', () => {
    debugLog('Initializing NotaryAI application');
    
    // Track page load
    trackPageView('NotaryAI Homepage');
    ...
    debugLog('NotaryAI application initialized successfully');
