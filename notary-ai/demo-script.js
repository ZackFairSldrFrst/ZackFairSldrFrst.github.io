...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (typeof gtag !== 'undefined') {
        gtag('event', 'page_view', {
            page_title: 'NotaryAI Demo Platform',
...
function initializeInteractivity() {
    ...
    // Initialize NotaryScan functionality
    initializeNotaryScan();
...
function initializeChat() {
    const chatInput = document.getElementById('demoChat');
    ...
    if (chatInput && chatSendButton) {
        function sendMessage() {
            ...
            setTimeout(() => {
                addChatMessage('The AI is analyzing your notary question...', 'ai');
            }, 500);
            
            // Simulate AI response
            setTimeout(() => {
                const responses = [
                    "Based on state notary laws, here's what you need to know...",
                    "For notarization requirements, the key considerations are...",
                    "According to the National Notary Association guidelines...",
                    "The document authentication process requires...",
                    "Interstate notary regulations specify that..."
                ];
...
function simulateFileUpload() {
    ...
    trackDemoInteraction('file_upload_demo', 'notaryscan');
    ...
    uploadZone.innerHTML = `
        <div class="upload-progress">
            ...
            <p>Processing Real Estate Purchase Agreement</p>
    ...
    setTimeout(() => {
        ...
        trackDemoInteraction('file_upload_complete', 'notaryscan');
    ...
    uploadZone.innerHTML = `
        <div class="upload-icon">
            <i class="fas fa-cloud-upload-alt"></i>
                    ...
                    <h4>Upload Documents for Review</h4>
            <p>Drag & drop or click to upload contracts, deeds, powers of attorney, or other notarial documents</p>
    ...
    dropdown.innerHTML = `
        ...
        <div class="notification-list">
            <div class="notification-item unread">
                ...
                <div>
                    <div class="notification-title">New NotaryScan analysis complete</div>
    ...
    dropdown.innerHTML = `
        <div class="user-info">
            ...
            <div>
                ...
                <div class="user-role">Senior Document Manager</div>
            </div>
        </div>
        <div class="user-menu">
...
function openTypeform() {
    ...
    if (typeof window.lintrk === 'function') {
        window.lintrk('track', { conversion_id: 20186196 });
    }
    
            window.open('https://form.typeform.com/to/Om7IF785', '_blank', 'width=800,height=600,scrollbars=yes,resizable=yes');
}
